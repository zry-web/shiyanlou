<template>
  <div class="not_found_page_div">
    <img
      class="not_found_wrap_image"
      src="https://static.shiyanlou.com/frontend/dist/img/9692684.png"
    />
    <div class="not_found_side">
      <img
        class="not_found_side_404"
      ...
      />
      <p class="text">Sorry，页面走丢了...</p>
      <a href="/" class="back_to_home_button">返回首页</a>
    </div>
  </div>
</template>
