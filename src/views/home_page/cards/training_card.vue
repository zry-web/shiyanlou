<template>
  <div class="training_card">
    <div class="training_card_img_div">
      <router-link class="training_card_a" tag="a" :to="{ name: 'course', params: {id: data._id} }">
        <img :src="data.coverImg" class="training_card_img" />
      </router-link>
    </div>
    <div class="training_card_text_div">
      ...
      <div class="training_card_text_footer_div">
        ...
        <router-link
          class="go_to_detail_a"
          tag="a"
          target="_blank"
          :to="{ name: 'course', params: {id: data._id } }"
        >查看详情</router-link>
      </div>
    </div>
  </div>
