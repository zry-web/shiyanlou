<template>
  <div class="course_card_div">
    <div class="course_div">
      <router-link tag="a" class="course_img_a" :to="{ name: 'course', params: {id: data._id} }">
        <div class="course_img_div">
          <img :src="data.coverImg" class="course_img_img" />
        </div>
        <div class="course_body">
          <div class="course_description_title_div">{{ data.title }}</div>
          <div class="course_description_div">{{ data.descriptions }}</div>
          <div class="course_information_div">
            <div>
              <i class="fa fa-users"></i>
              <span class="members_p">{{ data.studentsCount }}</span>
            </div>
            <p
              class="course_type_p"
              :class="[data.courseType]=='会员'?'vip_course_p':([data.courseType]==''?'':'training_course_p')"
            >{{ data.courseType}}</p>
          </div>
        </div>
      </router-link>
